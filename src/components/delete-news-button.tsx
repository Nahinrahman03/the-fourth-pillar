...
export function DeleteNewsButton({ newsId, headline }: Props) {
  ...
  if (confirming) {
    return (
      <div className="delete-confirm-row">
        <span className="delete-confirm-text">Delete &ldquo;{headline.slice(0, 48)}{headline.length > 48 ? "…" : ""}&rdquo;?</span>
  ...
  return (
    <button
      aria-label={`Delete news: ${headline}`}
